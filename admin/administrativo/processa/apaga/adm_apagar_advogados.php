	  ...
	  <div class='modal-dialog'>
		<div class='modal-content'>
		  ...
		  <div class='modal-footer'>
			<a href='adm_apagar_advogados.php?id=<?php echo "$id";?>&apaga=1' class='btn btn-sm btn-danger' data-bs-dismiss='modal'>sim</a>
			<a href='../../../administrativo.php?link=68' class='btn btn-sm btn-success' data-bs-dismiss='modal'>não</a>
		  </div>
		</div>
	  </div>
	</div>
					...
					<div class='modal fade z-3' id='myModal' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
					  <div class='modal-dialog'>
						<div class='modal-content'>
						  ...
						  <div class='modal-body'>
							Não pode ser apagado, devido ter clientes associados!
						  </div>
						  <div class='modal-footer'>
							<a href='../../../administrativo.php?link=68' class='btn btn-sm btn-primary' data-bs-dismiss='modal'>ok</a>
						  </div>
						</div>
					  </div>
					</div>
