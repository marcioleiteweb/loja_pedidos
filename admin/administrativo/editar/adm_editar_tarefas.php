...
<div class="container theme-showcase" role="main">
	...
	<form class="form-horizontal" method="POST" action="administrativo/processa/edita/adm_proc_edita_tarefas.php" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="nome_tarefa" required class="form-control" id="inputEmail3" placeholder="Nome" value="<?php echo $row_tarefas['nome_tarefa']; ?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea id="mytextarea1" name="descricao_tarefa" class="form-control" maxlength="800" rows="7" id="inputEmail3" placeholder="Descrição" required><?php echo $row_tarefas['descricao_tarefa']; ?></textarea>
			</div>
		</div>	
