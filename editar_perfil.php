...
<div class="container theme-showcase" role="main">
	...
	<form class="form-horizontal" id="adm_cad_central" method="POST" action="admin/administrativo/processa/edita/adm_proc_editar_membro.php" enctype="multipart/form-data">
	
	
		<div class="form-group">
			<label class="col-sm-2 control-label">Nome</label>
			<div class="col-sm-10">
				<input type="text" name="nome" required class="form-control" id="inputEmail3" value="<?php echo $row_produtos['nome']; ?>" placeholder="Nome Completo">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="email" name="email" required class="form-control" id="inputEmail3" value="<?php echo $row_produtos['email']; ?>" placeholder="Coloque aqui seu melhor email">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="password" name="senha" required class="form-control" id="inputPassword3" value="<?php echo $row_produtos['senha_real']; ?>" placeholder="Senha">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="numbe" id="celular" name="celular" class="form-control" maxlength="14" value="<?php echo $row_produtos['celular']; ?>" id="inputEmail3" placeholder="Celular">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				  <input type="date" name="data_nascimento" value="<?php echo $row_produtos['data_nascimento']; ?>" class="form-control">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="rua" required class="form-control" id="inputEmail3" value="<?php echo $row_produtos['rua']; ?>" placeholder="Rua">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="bairro" required class="form-control" id="inputEmail3" value="<?php echo $row_produtos['bairro']; ?>" placeholder="Bairro">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="cidade" required class="form-control" id="inputEmail3" value="<?php echo $row_produtos['cidade']; ?>" placeholder="Cidade">
			</div>
		</div>
...
<div class="form-group">
	...
	<div class="col-sm-10">		
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="numb" id="cep" name="cep" required class="form-control" maxlength="9" id="inputEmail3" value="<?php echo $row_produtos['cep']; ?>" placeholder="CEP">
			</div>
		</div>
